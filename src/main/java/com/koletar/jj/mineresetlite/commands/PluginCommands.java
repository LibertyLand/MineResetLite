...
public class PluginCommands
{
    ...
    @Command(aliases = {"about"}, description = "List version and project information about MRL",
            help = {"Show version information about this installation of MRL, in addition",
                    "to the authors of the plugin."}, max = 0)
